            ...
            lock (_lock)
            {
                ...
                if (_instance == null)
                {
                    ...
                    if (_instance == null)
                    {
                        ...
                        Debug.LogWarning("[Singleton] An instance of " + typeof(T) + " is needed in the scene, so '" + newSingleton 
                    ...
                    {
                        Debug.LogError("[Singleton] You somehow have two Singletons of the same type in this scene. " + 
                        "Unclear which one is desired, going with first one found.");
                    }
